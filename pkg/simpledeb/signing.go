...
func createKeyPair(name, comment, email string) (*openpgp.Entity, []byte, []byte) {
...
func CreateKey(name, email string) CreateKeyOutput {
	_, publicKey, privateKey := createKeyPair(name, "Generated by github.com/glassechidna/simpledeb", email)
